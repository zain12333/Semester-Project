 ...
 * Use the [BSVaddNoteFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BSVaddNoteFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment BSVaddNoteFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BSVaddNoteFragment().apply {
